...
wb = load_workbook('C:\\Users\\kanda\\Desktop\\excel.xlsx')
...
if __name__ == "__main__":
	...
	scssc = Label(root, text="Chọn môn học", bg="light green")
	...
	address_field.grid(row=8, column=1, ipadx="100")
